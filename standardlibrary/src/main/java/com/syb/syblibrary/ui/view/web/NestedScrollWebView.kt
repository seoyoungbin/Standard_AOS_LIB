...
class NestedScrollWebView : BaseWebView
{
    ...
    override fun dispatchNestedPreFling(velocityX: Float, velocityY: Float): Boolean = mChildHelper?.dispatchNestedPreFling(velocityX, velocityY)!!
